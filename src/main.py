...
def process_files(downloader: S3ProcessingPipeline, transcriber: AudioTranscriber, local_dir: str, logger: logging.Logger):
...
def main():
    ...
    try:
        ...
        downloader = S3ProcessingPipeline(bucket_name, download_dir=local_dir)
        
        # Start downloading
        logger.info("Starting download process...")
        downloader.start_downloading(local_dir)
